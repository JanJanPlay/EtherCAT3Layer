...
#define    DISABLE_SYNC0_INT       	HAL_NVIC_DisableIRQ(EXTI3_IRQn);	 
#define    ENABLE_SYNC0_INT         HAL_NVIC_EnableIRQ(EXTI3_IRQn);
...
#define STOP_ECAT_TIMER     HAL_TIM_Base_Stop_IT(&htim2);

#define START_ECAT_TIMER    HAL_TIM_Base_Start_IT(&htim2)
...
#if AL_EVENT_ENABLED			//IRQ
//    INIT_ESC_INT;
    ENABLE_ESC_INT();
#endif

#if DC_SUPPORTED&& _STM32_IO8	//SYNC0 SYNC1
//    INIT_SYNC0_INT
//    INIT_SYNC1_INT
