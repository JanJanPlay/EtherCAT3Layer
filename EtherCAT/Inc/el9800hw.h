...
#define PRAM_RW_ABORT_MASK      ((uint32_t)1 << 30)
#define PRAM_RW_BUSY_32B        ((uint32_t)1 << 31)
...
#define    DISABLE_ESC_INT()           HAL_NVIC_DisableIRQ(EXTI0_IRQn)		// {(_INT1IE)=0;} /**< \brief Disable interrupt source INT1*/
#endif
#ifndef ENABLE_ESC_INT
#define    ENABLE_ESC_INT()           HAL_NVIC_EnableIRQ(EXTI0_IRQn)			// {(_INT1IE)=1;} /**< \brief Enable interrupt source INT1*/
#endif
